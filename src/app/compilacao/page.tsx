...
import { useCompilaController, SongbookPdfConfig, FONT_SIZES, COLUMNS } from '@/controllers/useCompilaController'
import { PdfOrientation } from '@/views/PdfDocument'

const SongbookDownloader = dynamic(() => import('@/views/SongbookDownloader'), { ssr: false })
