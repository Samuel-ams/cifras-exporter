...
const PlaylistPdfDownloadButton = dynamic(() => import('@/views/PlaylistPdfDownloadButton'), { ssr: false })
        ...
        <div className="fade-up">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
                ...
                <div className="w-full flex gap-2 items-center md:justify-end">
                    ...
                    <button onClick={handleDelete} className="btn-danger shrink-0 flex items-center gap-1.5 min-h-9.5">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className="flex flex-col gap-2">
                            {playlistCifras.map((cifra, idx) => (
                                <div key={cifra.id} className="surface p-3 px-4 flex items-center gap-3">
                                    ...
                                    {/* Remove */}
                                    <button
                                        onClick={async () => {removeCifra(cifra.id)}}
